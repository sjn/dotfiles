...
alias decibel.pvv-s='ssh -2 -4 -C -t -A -l sjn decibel.pvv.ntnu.no screen -Ux'
...
dotfiles='bashrc,bash_profile,aliases,screenrc,bash_aliases,vimrc,inputrc,irssi/config'
